...
<title>NextGen | Edit Brand</title>
@section('content')
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('brands.index')}}" class="btn btn-sm fw-bold btn-success">Back</a>
                    <!--end::success button-->
                </div>
                <!--end::Actions-->
            </div>
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 pe-lg-10">
                                <!--begin::Form-->
                                <form action="" class="form mb-15 text-center" method="post" id="edit_brand_form">
                                    <h1 class="fw-bold text-dark mb-9">Edit Brand</h1>
                                    <div class="row mb-5">
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column fv-row">
                                                <label class="fs-5 fw-semibold mb-2 text-start">Name</label>
                                                <input class="form-control form-control-solid" value="{{ $brand->name }}" type="text" placeholder="" name="name" id="name" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column fv-row">
                                                ...
                                                <input class="form-control form-control-solid" value="{{ $brand->slug }}" type="text" placeholder="" name="slug" id="slug" readonly />
                                                <p class="text-danger mt-2"></p>
                                            </div>
                                        </div>
                                    </div>
...
@section('customJs')
<script>
    $("#edit_brand_form").submit(function(event) {
