...
<title>NextGen | Create Brand</title>
@section('content')
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Create Brand</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 pe-lg-10">
                                <!--begin::Form-->
                                <form action="" class="form mb-15 text-center" method="post" id="brand_form">
                                    <h1 class="fw-bold text-dark mb-9">Create Brand</h1>
                                    <div class="row mb-5">
                                        <div class="col-md-6">
