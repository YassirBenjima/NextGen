...
<title>NextGen | Edit Sub Category</title>
@section('content')
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit Sub Category</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 pe-lg-10">
                                ...
                                <form action="" class="form mb-15 text-center" method="post" id="sub_category_form">
                                    <h1 class="fw-bold text-dark mb-9">Edit Sub Category</h1>
                                    <div class="row mb-5">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column fv-row">
                                                ...
                                                <input class="form-control form-control-solid" value="{{ $subCategory->name }}" type="text" placeholder="" name="name" id="name" />
                                                <p class="text-danger mt-2"></p>
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column fv-row">
                                                ...
                                                <input class="form-control form-control-solid" value="{{ $subCategory->slug }}" type="text" placeholder="" name="slug" id="slug" readonly />
                                                <p class="text-danger mt-2"></p>
