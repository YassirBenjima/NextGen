...
<title>NextGen | Edit Product</title>
@section('content')
<!--begin::Main-->
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">Edit Your Product</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
                            ...
                            <div class="card-body border-top p-9">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 fv-row">
                                                <input type="text" id="title" name="title" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Title" value="{{ $product->title }}" />
                                            ...
                                            <!--begin::Col-->
                                            <div class="col-lg-6 fv-row">
                                                <input type="text" readonly id="slug" name="slug" class="form-control form-control-lg form-control-solid" placeholder="Slug" value="{{ $product->slug }}" />
                                                <p class="text-danger mt-2"></p>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <textarea id="short_description" name="short_description" cols="30" rows="10" class="form-control form-control-lg form-control-solid" placeholder="" value="">{{ $product->short_description }}</textarea>
                                    </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <textarea id="description" name="description" cols="30" rows="10" class="form-control form-control-lg form-control-solid" placeholder="" value="">{{ $product->description }}</textarea>
                                    </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <textarea id="shipping_returns" name="shipping_returns" cols="30" rows="10" class="form-control form-control-lg form-control-solid" placeholder="" value="">{{ $product->shipping_returns }}</textarea>
                                    </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" id="price" name="price" class="form-control form-control-lg form-control-solid" placeholder="pricing" value="{{ $product->price }}" />
                                        <p class="text-danger mt-2"></p>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" id="compare_price" name="compare_price" class="form-control form-control-lg form-control-solid" placeholder="Compare Price" value="{{ $product->compare_price }}" />
                                        <p class="text-danger mt-2"></p>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <!--begin::Col-->
                                            <div class="col-lg-6">
                                                <input type="text" id="sku" name="sku" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="SKU" value="{{ $product->sku }}" />
                                                <p class="text-danger mt-2"></p>
                                            ...
                                            <!--begin::Col-->
                                            <div class="col-lg-6 fv-row">
                                                <input type="text" id="barcode" name="barcode" class="form-control form-control-lg form-control-solid" placeholder="Barcode" value="{{ $product->barcode }}" />
                                                <p class="text-danger mt-2"></p>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <!--begin::Col-->
                                            <div class="col-lg-12">
                                                <input type="text" id="quantity" name="quantity" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Quantity" value="{{ $product->qty }}" />
                                                <p class="text-danger mt-2"></p>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">Related Product</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <!--begin::Row-->
                                        <div class="row">
                                            <!--begin::Col-->
                                            <div class="col-lg-12">
                                                <select multiple class="form-select form-control-solid related_products w-100" placeholder="" id="related_products" name="related_products[]">
                                                    <!-- <option {{ ($product->is_featured == 'No') ? 'selected' : ''}} value="No">No</option>
                                                    <option {{ ($product->is_featured == 'Yes') ? 'selected' : ''}} value="Yes">Yes</option> -->
