...
<title>NextGen | Users List</title>
@section('content')
<!--begin::Main-->
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('users.create')}}" class="btn btn-sm fw-bold btn-success">Create User</a>
                    <!--end::success button-->
                </div>
                <!--end::Actions-->
            </div>
                    ...
                    <form action="" method="get">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-title">
                                <a href="{{ route('users.index') }}" class="btn btn-primary btn-md">Reset</a>
                                <!--begin::Search-->
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <!--end::Svg Icon-->
                                    <input value="{{ Request::get('keyword')}}" type="text" name="keyword" id="keyword" data-kt-ecommerce-order-filter="search" class="form-control form-control-solid ps-14" placeholder="Search User" style="margin-left: 20px;" />
                                </div>
                            ...
                            <tbody class="fw-semibold text-gray-600 text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-dark">
                                        ...
                                        <!-- Delete Button -->
                                        <a href="#" onclick="deleteUser('{{$user->id}}')" class="btn btn-default btn-sm">
