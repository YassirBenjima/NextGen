                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 pe-lg-10">
                                ...
                                <form action="" class="form mb-15 text-center" method="post" id="user_form">
                                    <h1 class="fw-bold text-dark mb-9">Edit User</h1>
                                    <div class="row mb-5">
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column fv-row">
                                                <label class="fs-5 fw-semibold mb-2 text-start">Name</label>
                                                <input class="form-control form-control-solid" value="{{ $user->name }}" type="text" placeholder="" name="name" id="name" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column fv-row">
                                                ...
                                                <input class="form-control form-control-solid" value="{{ $user->phone }}" type="text" placeholder="" name="phone" id="phone" />
                                                <p class="text-danger mt-2"></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-5">
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column fv-row">
                                                ...
                                                <input class="form-control form-control-solid" value="{{ $user->email }}" type="text" placeholder="" name="email" id="email" />
                                                <p class="text-danger mt-2"></p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column fv-row">
                                                ...
                                                <p class="text-danger mt-2">To Change Password You Have To Enter Value Otherwise Leave Blank</p>
                                            </div>
                                        </div>
                                    </div>
