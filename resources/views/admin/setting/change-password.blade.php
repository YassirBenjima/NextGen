        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('admin.logout')}}" class="btn btn-sm fw-bold btn-success">Sign Out</a>
                    <!--end::Primary button-->
                </div>
            </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                @if(session('success'))
                        ...
                        @endif
                        @if(session('error'))
                        <div class="alert alert-dange" id="dangerMessage">
                            {{ session('error') }}
                        </div>
                        @endif
                    ...
                    <div class="card-body pt-9 pb-0">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="fs-2 fw-bold" data-kt-countup="true">
                                                        {{number_format($totalRevenue,0)}} MAD
                                                    </div>                                               
                                                </div>
                                                <!--end::Number-->
                                                <!--begin::Label-->
                                            ...
                                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                    <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="{{$totalOrdersDelivered}}">{{$totalOrdersDelivered}}</div>
                                                </div>
                                                <!--end::Number-->
                                                <!--begin::Label-->
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{route('setting.change-password')}}">Settings</a>
                            </li>
                            <!--end::Nav item-->
                        </ul>
                        <!--begin::Navs-->
                        ...
                        <form id="kt_account_profile_details_form" class="form">
                            ...
                            <div class="card-body border-top p-9">
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name" value="{{$user->name}}" disabled/>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="tel" name="phone" class="form-control form-control-lg form-control-solid" placeholder="Phone number" value="{{$user->phone}}" disabled/>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Email number must be active"></i>
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="email" name="email" class="form-control form-control-lg form-control-solid" placeholder="Email" value="{{$user->email}}" disabled/>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a href="{{route('setting.change-password')}}" class="btn btn-light btn-active-light-primary me-2">Discard</a>
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-10">
                                ...
                                <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                                    <!--begin::Form-->
                                    <form action="" id="kt_signin_change_password" name="kt_signin_change_password" class="form">
                                        <div class="row mb-1">
                                            <div class="col-lg-4">
            ...
            $.ajax({
                ...
                success: function(response){
                    if(response.status == true){
                        window.location.href = '{{route("setting.change-password")}}';
                    }
                }
            });
        });
