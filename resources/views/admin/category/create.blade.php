...
<title>NextGen | Category Create</title>
@section('content')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 pe-lg-10">
                                ...
                                <form action="" class="form mb-15 text-center" method="post" id="category_form">
                                    <h1 class="fw-bold text-dark mb-9">Create Category</h1>
                                    <div class="row mb-5">
                                        <div class="col-md-6">
    ...
    const dropzone = new Dropzone("#image", {
        init: function() {
            ...
            this.on('success', function(file, response) {
                $("#image_id").val(response.image_id); // Assurez-vous que `response.image_id` est bien défini
            });
            this.on('error', function(file, response) {
                console.error('Erreur de téléchargement:', response); // Ajoutez des logs pour les erreurs
            });
        },
